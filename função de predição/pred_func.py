...
if __name__ == "__main__":
    ...
    m=100
    image_path = "./imagens/rafael_img2.png"
    ...
    df_pred.to_csv(f"./predições/{image_path.split('/')[-1]}_mac_hybrid_pred.csv")
    df_train.to_csv(f"./predições/{image_path.split('/')[-1]}_mac_hybrid_train.csv")